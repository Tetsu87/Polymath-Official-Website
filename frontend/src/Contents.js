          ...
          <Row>
            <Col className="m-o p-0">
              <div className="profile-wrapper">
                ...
                <div className="small-letter profile-width px-1">
                  <p>
              ...
              <div className="profile-wrapper">
                ...
                <div className="small-letter profile-width px-1">
                  ...
                  <p>
                    ...
                    <a href="https://www.amazon.com/Python-Machine-Learning-Blueprints-developing-ebook/dp/B07JLMHWRG" target="_blank" className="book-link">『Python Machine Learning Blueprints』</a>
